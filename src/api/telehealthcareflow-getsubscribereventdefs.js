...
class TeleHealthcareFlowGetSubscriberEventDefs extends PolymerElement {
  static get template() {
    return html`
  ...
  _handleResponse(e) {
    ...
    this.dispatchEvent(new CustomEvent("subscriber-events", { detail: { 'data': response.events }}));
  }

  getEventdefs(email) {
      this.$.client._dataChanged();
      this._postEvent = "GetSubscriberEventDefs";
      var postData = {};
      var postTo = {};
...
window.customElements.define('telehealthcareflow-getsubscribereventdefs', TeleHealthcareFlowGetSubscriberEventDefs);
