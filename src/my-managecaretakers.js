  ...
  static get template() {
    return html`
      ...
      <div class="card-header">
        <div class="flex-1 event-title self-end">Care givers</div>
      </div>
      <div class="card-content">
        <div class="content-two">
          <div class="layout horizontal title-container">
            <div class="flex title">Care givers</div>
            <paper-button class="filledBlue" on-tap="_openAddEditDialog">+ add caregiver</paper-button>
          </div>
          <search-listview class="search-result" columns="[[columns]]"
            search-result="{{subscriber.caretakers}}" mode="{{_mode}}" on-action-edit="_showDetails"></search-listview>
        </div>
      </div>
      ...
      <telehealthcareflow-searcheventtemplates id="searchevents"></telehealthcareflow-searcheventtemplates>
    `;
  }
